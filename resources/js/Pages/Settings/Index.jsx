                ...
                <form onSubmit={handleSubmit} className="w-full">
                    ...
                    <div className="bg-surface-container-lowest dark:bg-dark-surface border border-outline-variant dark:border-dark-outline rounded-xl p-4 sm:p-6 shadow-sm flex flex-col gap-6 w-full">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            {/* BANNER INFORMATIVO TASA BCV EN TIEMPO REAL */}
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="grid grid-cols-2 bg-surface-container-low dark:bg-dark-background border dark:border-dark-outline p-1 rounded-lg h-10 items-center">
                                        <button
                                            ...
                                            className={`h-full rounded-md text-[11px] font-black uppercase tracking-wider transition-all ${data.bcv_mode === 'auto'
                                        ...
                                        <button
                                            ...
                                            className={`h-full rounded-md text-[11px] font-black uppercase tracking-wider transition-all ${data.bcv_mode === 'manual'
                                                ? 'bg-primary text-on-primary dark:bg-dark-primary dark:text-dark-background shadow-sm'
                                                : 'text-on-surface-variant dark:text-dark-on-surface-variant hover:bg-surface-container-high dark:hover:bg-neutral-800'
                                                }`}
                                        >
                            ...
                            {/* Botón de consulta forzada exclusivo para modo automático */}
                            {data.bcv_mode === 'auto' && (
                                <div className="flex justify-end mt-1">
                                    <button
                                        ...
                                        className="w-full sm:w-auto flex items-center justify-center gap-1.5 px-4 h-9 rounded-lg border border-outline-variant dark:border-dark-outline text-primary dark:text-dark-primary font-black text-[11px] uppercase tracking-wider hover:bg-primary/5 dark:hover:bg-dark-primary/5 transition-colors disabled:opacity-50"
                                    >
                        ...
                        {/* SEPARADOR INTERNO */}
                        <div className="border-t border-outline-variant/30 dark:border-dark-outline"></div>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start mt-1">
                                ...
                                <div className="flex flex-col gap-1.5">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant">Fondo de Negocio ({data.business_percentage}%)</label>
                                    <div className="relative h-10">
                                        <input
                                            type="text"
                                            inputMode="numeric"
                        ...
                        {/* SEPARADOR Y BOTÓN DE GUARDADO */}
                        <div className="border-t border-outline-variant/30 dark:border-dark-outline pt-2 flex justify-end">
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full sm:w-auto px-8 py-3 bg-primary dark:bg-dark-primary text-on-primary dark:text-dark-background font-black text-xs uppercase tracking-wider rounded-lg shadow-md hover:opacity-90 disabled:opacity-50 transition-all flex justify-center items-center gap-2"
                            >
